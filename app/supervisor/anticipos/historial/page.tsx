// app/supervisor/anticipos/historial/page.tsx
'use client'
...
export default function HistorialPage() {
  ...
  // Obtener employeeId del supervisor
  const employeeId = session?.user?.adUser?.employeeID || 
                     session?.user?.email?.split('@')[0] || ''

  // Obtener nombre del supervisor
  const nombreSupervisor = session?.user?.name || 'Supervisor'
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">
                    {nombreSupervisor} • Panel de Supervisor
                  </p>  
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-400">
                    ...
                    Esta funcionalidad permitirá a los supervisores ver anticipos específicos por campaña.
                  </p>
                </div>
              </div>
            </div>
